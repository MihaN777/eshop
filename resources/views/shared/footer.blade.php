    ...
    <div class="container">
        <div class="flex flex-wrap lg:flex-nowrap items-center">
            <div class="footer-logo order-0 basis-full sm:basis-1/2 lg:basis-1/3 shrink-0 text-center sm:text-left">
                <a href="{{ route('home') }}" class="inline-block" rel="home" style="font-weight:bold; font-size:25px;">
                    [ LOGO ]
            ...
            <div class="footer-copyright order-2 lg:order-1 basis-full lg:basis-1/3 mt-8 lg:mt-0">
                <div
                    class="text-[#999] text-xxs xs:text-xs sm:text-sm text-center">{{ config('app.name') . ', ' . now()->format('Y') }}
                    © Все права защещены.
                </div>
    ...
    <div class="container">
        <div class="mmenu-heading flex items-center pt-6 xl:pt-12">
            <div class="shrink-0 grow">
                <a href="{{ route('home') }}" rel="home" style="font-weight:bold; font-size:25px; color:black;">
                    [ LOGO ]
                    {{--                    <img src="./images/logo-dark.svg" class="w-[148px] md:w-[201px] h-[36px] md:h-[50px]" alt="Logo">--}}
                </a>
            </div>
        ...
        <div class="mmenu-inner pt-10">
                ...
                <div class="flex items-center">
                    ...
                    <div class="flex flex-col items-start ml-4">
                        ...
                        <form method="POST" action="{{ route('logout') }}"
                            ...
                            <button type="submit" class="ml-[6px] font-medium">
                                Выйти
                            </button>
                        </form>
                    </div>
            ...
            <nav class="flex flex-col mt-8">
                ...
                <a href="{{ route('catalog.categories') }}" class="self-start py-1 text-dark hover:text-pink text-md font-bold">Каталог
                    товаров</a>
