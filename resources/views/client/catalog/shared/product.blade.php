<div class="product-card flex flex-col rounded-3xl bg-card">
    <a href="{{ route('catalog.product', $product) }}" class="product-card-photo overflow-hidden h-[320px] rounded-3xl">
    ...
    <div class="grow flex flex-col py-8 px-6">
        <h3 class="text-sm lg:text-md font-black">
            <a href="{{ route('catalog.product', $product) }}" class="inline-block text-white hover:text-pink">
                {{ $product->title }}
            </a>
        </h3>
